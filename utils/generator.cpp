...
template<typename Container,
    ...
    typename Generator = ElementAllocator<Type>
>
...
template<typename Container,
    typename Generator = ElementAllocator<typename Container::value_type>
>
Container populate_container(int count) {
    // Log log("populate_container");
    ContainerGenerator<Container, typename Container::value_type, Generator> generator;
